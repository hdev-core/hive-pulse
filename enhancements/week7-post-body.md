<!-- ─────────────────────────────────────────────────────────────────────────────
     PASTE-READY. Everything below the marker is the post body, exactly as it
     should appear. Each paragraph is ONE unbroken line on purpose — Hive
     frontends render a newline inside a paragraph as a real line break, so
     re-wrapping this to a column width splits sentences mid-way.

     TITLE (paste into the title field):
       HivePulse SEO Contest: New Week 7 Round (Up To 500 HIVE)

     PREVIEW DESCRIPTION (133 chars — PeakD: "Short preview description"
     under the editor; Ecency: the Story preview step):
     ...
     FOCUS KEYWORD (analyzer field):  hivepulse seo contest
     COMMUNITY:                       Hdev Contests (hive-177727)
     TAGS:                            hivepulse seo contest hive writing

     TWO IMAGES TO UPLOAD — drag the file into the editor, never paste
     (pasting serialises a bitmap and inflates it 5-8x):
       1. enhancements/images/contest-week7-cover.jpg      -> replaces PASTE_UPLOADED_COVER_URL_HERE
       2. enhancements/images/social/geo-vs-seo-week6.jpg  -> replaces PASTE_UPLOADED_CHART_URL_HERE
