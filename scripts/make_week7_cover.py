#!/usr/bin/env python3
"""
Week-7 contest cover, drawn in the HivePulse house style.

    python scripts/make_week7_cover.py

Writes enhancements/images/contest-week7-cover.jpg at 1920x1080.
...
W, H = 1920, 1080
OUT = 'enhancements/images/contest-week7-cover.jpg'
SHADOW = (10, 16, 34)
...
def main():
    im = bs.gold_ground(W, H, bloom=(0.5, 0.30), intensity=1.0, seed=71)
    d = ImageDraw.Draw(im)
    ...
    bs.gold_text(im, (W // 2, 250), 'WEEK 7 IS OPEN', bs.font('bold', 112),
                 anchor='ma', stroke=8)
    ...
    d.text((W // 2, H - 62), 'Closes 15 September 2026, 12:00 UTC   ·   Tag #hivepulse',
